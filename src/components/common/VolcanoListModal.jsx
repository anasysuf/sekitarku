...
import { Flame, X, Search, MapPin, Compass, AlertTriangle, ShieldCheck } from 'lucide-react';
...
export function VolcanoListModal({ isOpen, onClose, userLocation, onSelectVolcano, lang = 'id' }) {
